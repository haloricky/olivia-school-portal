...
function ClockFace({ hour, minute }) {
  ...
  return <svg viewBox="0 0 120 120" width="150" height="150" className="mx-auto drop-shadow-md">
...
function ClockReadingGame() {
  ...
  if (done) return <div className="text-center space-y-5 py-4 font-display">
      <div className="text-7xl animate-bounce">{score === ROUNDS.length ? "\u{1F3C6}" : score >= 6 ? "\u2B50" : "\u23F0"}</div>
  ...
  return <div className="space-y-4 font-display">
    ...
    >
      ...
      {confirmed && <div className="rounded-2xl px-4 py-3 flex gap-2 items-center" style={{ background: isCorrect ? "#dcfce7" : "#fff7ed", border: `2px solid ${isCorrect ? "#86efac" : "#fdba74"}` }}>
