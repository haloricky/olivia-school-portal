  ...
  return <div className="flex flex-col gap-3" style={{ fontFamily: "Nunito, sans-serif" }}>
    ...
    /* Title */
      ...
      <div className="text-center">
        <h3 className="text-lg font-extrabold mb-0.5" style={{ color: "#2a9fc7" }}>
          My Amazing Body: A Picture Story
        </h3>
    ...
    style={{
      width: i === page ? 24 : 10,
      height: 10,
      backgroundColor: i === page ? accent : i < page ? "#90EE90" : "#e5e7eb"
    }}
  />)}
      </div>
    ...
    style={{ backgroundColor: "#E8F4FD", border: "2px solid #4FC3F7" }}
  >
