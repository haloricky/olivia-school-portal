...
const QUESTIONS = [
  { q: "What do we call the leader who is chosen by the people to run a whole country — like the leader of the USA or Indonesia?", choices: ["Mayor", "King", "President", "Prime Minister"], answer: "President", emoji: "🏛️", fact: "A President is elected (chosen by votes) by the citizens to lead the country. Indonesia's President (Presiden) leads the government, the armed forces, and represents Indonesia to the world." },
  { q: "In countries like the UK and Australia, the elected head of government is called what?", choices: ["President", "Prime Minister", "Chancellor", "Emperor"], answer: "Prime Minister", emoji: "🇬🇧", fact: "A Prime Minister is the head of government in parliamentary countries. The UK, Australia, Canada, India, and Malaysia all have Prime Ministers. They are chosen by the parliament, not a direct public vote." },
  { q: "Some countries have a royal family whose role is passed down through generations. What do we call the male ruler?", choices: ["President", "Mayor", "King", "Governor"], answer: "King", emoji: "👑", fact: "A King (or Queen) rules a monarchy — a country where power is inherited by royal families. Today most kings and queens are 'constitutional' — they are symbolic leaders, and a Prime Minister actually runs the government." },
  { q: "Who runs a city — like the leader of Jakarta, Surabaya, or New York City?", choices: ["Governor", "Mayor", "Admiral", "Senator"], answer: "Mayor", emoji: "🏙️", fact: "A Mayor runs a city or large town. Jakarta's leader is called a Governor (Gubernur) because Jakarta is a special capital region. Most Indonesian cities have a Mayor (Wali Kota)." },
...
export default function LeaderMatchGame() {
