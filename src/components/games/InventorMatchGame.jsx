...
const PAIRS = [
  { id: "davinci",      name: "Leonardo da Vinci", flag: "🇮🇹", fact: "Painted the Mona Lisa and The Last Supper; also designed flying machines, tanks, and robots — 500 years before they existed!", color: "#e07c54" },
  { id: "michelangelo", name: "Michelangelo",      flag: "🇮🇹", fact: "Painted the ceiling of the Sistine Chapel lying on his back for 4 years — it shows the creation of Adam and 300 other figures!", color: "#5a9ad4" },
  { id: "galileo",      name: "Galileo Galilei",   flag: "🇮🇹", fact: "Improved the telescope and proved that Earth orbits the Sun — not the other way around. He was put under house arrest for this idea!", color: "#d4a82e" },
  { id: "gutenberg",    name: "Johannes Gutenberg", flag: "🇩🇪", fact: "Invented the printing press around 1440, making it possible to print books quickly. This spread knowledge across the whole world!", color: "#8bc34a" },
  { id: "shakespeare",  name: "William Shakespeare", flag: "🇬🇧", fact: "Wrote 37 plays including Romeo and Juliet, Hamlet, and Macbeth — performed at the Globe Theatre in London", color: "#9c6fb5" },
  { id: "copernicus",   name: "Nicolaus Copernicus", flag: "🇵🇱", fact: "First to prove that the Earth and all planets orbit the Sun (heliocentric model) — completely changing how humans understood the universe", color: "#e57373" },
];
...
export default function InventorMatchGame() {
