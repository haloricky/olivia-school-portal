...
function IslandLabelGame() {
  ...
  if (done) return <div className="text-center space-y-5 py-4 font-display">
      <div className="text-7xl animate-bounce">{score === QUESTIONS.length ? "\u{1F3C6}" : score >= 4 ? "\u2B50" : "\u{1F3DD}\uFE0F"}</div>
