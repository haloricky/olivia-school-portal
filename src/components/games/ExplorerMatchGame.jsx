...
const DARK = "#5c3507";
const PAIRS = [
  { id: "columbus", name: "Christopher Columbus", flag: "\u{1F1EA}\u{1F1F8}", fact: "Sailed from Spain and reached the Americas in 1492 \u2014 opening a new world to Europeans", color: "#e07c54" },
  { id: "magellan", name: "Ferdinand Magellan", flag: "\u{1F1F5}\u{1F1F9}", fact: "Led the first expedition to sail ALL THE WAY around the entire globe (1519\u20131522)", color: "#5a9ad4" },
  { id: "dagama", name: "Vasco da Gama", flag: "\u{1F1F5}\u{1F1F9}", fact: "Found the sea route from Europe around Africa to India (1498) \u2014 revolutionising trade", color: "#d4a82e" },
  { id: "polo", name: "Marco Polo", flag: "\u{1F1EE}\u{1F1F9}", fact: "Travelled overland from Italy to China (1271) and wrote a famous book about his adventures", color: "#8bc34a" },
  { id: "cook", name: "James Cook", flag: "\u{1F1EC}\u{1F1E7}", fact: "First European to map the coasts of New Zealand and eastern Australia (1770)", color: "#9c6fb5" },
  { id: "battuta", name: "Ibn Battuta", flag: "\u{1F1F2}\u{1F1E6}", fact: "Muslim explorer from Morocco who travelled 120,000 km across Asia and Africa (1325\u20131368)", color: "#e57373" }
];
...
function ExplorerMatchGame() {
  ...
  if (done) return <div className="flex flex-col items-center gap-5 py-4 text-center font-display">
      ...
      <h3 className="font-extrabold text-2xl" style={{ color: COLOR }}>{moves <= 8 ? "Great Explorer!" : "Well done, explorer!"}</h3>
  ...
  return <div className="space-y-4 font-display">
      <div className="flex items-center justify-between">
        <div><h3 className="text-base font-extrabold" style={{ color: COLOR }}>Explorer Memory Match</h3><p className="text-xs text-gray-400 font-bold">Match each explorer to their famous voyage!</p></div>
