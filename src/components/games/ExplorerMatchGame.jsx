...
const PAIRS = [
  { id: "columbus",   name: "Christopher Columbus", flag: "🇪🇸", fact: "Sailed from Spain and reached the Americas in 1492 — opening a new world to Europeans", color: "#e07c54" },
  { id: "magellan",   name: "Ferdinand Magellan",   flag: "🇵🇹", fact: "Led the first expedition to sail ALL THE WAY around the entire globe (1519–1522)", color: "#5a9ad4" },
  { id: "dagama",     name: "Vasco da Gama",        flag: "🇵🇹", fact: "Found the sea route from Europe around Africa to India (1498) — revolutionising trade", color: "#d4a82e" },
  { id: "polo",       name: "Marco Polo",           flag: "🇮🇹", fact: "Travelled overland from Italy to China (1271) and wrote a famous book about his adventures", color: "#8bc34a" },
  { id: "cook",       name: "James Cook",           flag: "🇬🇧", fact: "First European to map the coasts of New Zealand and eastern Australia (1770)", color: "#9c6fb5" },
  { id: "battuta",    name: "Ibn Battuta",          flag: "🇲🇦", fact: "Muslim explorer from Morocco who travelled 120,000 km across Asia and Africa (1325–1368)", color: "#e57373" },
];
...
export default function ExplorerMatchGame() {
