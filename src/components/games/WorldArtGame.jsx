...
const PAIRS = [
  { id: "impressionism", name: "Impressionism", flag: "🇫🇷", country: "France", desc: "Soft, dreamy brushstrokes capturing light & colour — like Monet's water lilies", color: "#87CEEB" },
  { id: "ukiyo",         name: "Ukiyo-e",       flag: "🇯🇵", country: "Japan",  desc: "Woodblock prints of waves, mountains, and everyday life — like Hokusai's Great Wave", color: "#FF6B6B" },
  { id: "aboriginal",   name: "Aboriginal Art", flag: "🇦🇺", country: "Australia", desc: "Ancient dot paintings telling Dreamtime stories of the land and animals", color: "#FF8C00" },
  { id: "wayang",       name: "Wayang",         flag: "🇮🇩", country: "Indonesia", desc: "Shadow puppet art carved from buffalo hide — characters from Hindu epics", color: "#854F0B" },
  { id: "mosaic",       name: "Mosaic",         flag: "🏛️", country: "Ancient Rome & Greece", desc: "Pictures made by fitting tiny coloured tiles or stones together", color: "#DDA0DD" },
  { id: "renaissance",  name: "Renaissance Art",flag: "🇮🇹", country: "Italy", desc: "Lifelike paintings of people and nature — like the Mona Lisa by Leonardo da Vinci", color: "#90EE90" },
];
...
export default function WorldArtGame() {
