...
const BG = "#E8FBF5";
const QUESTIONS = [
  { q: "Which is the largest land animal on Earth?", choices: ["Giraffe", "Hippo", "Elephant", "Gorilla"], answer: "Elephant", emoji: "\u{1F418}", fact: "African elephants are the world's largest land animals! They can weigh as much as 6,000 kg \u2014 that's the same as 80 people standing together." },
  { q: "Which African big cat is called the King of the Jungle?", choices: ["Cheetah", "Leopard", "Tiger", "Lion"], answer: "Lion", emoji: "\u{1F981}", fact: "Lions live in groups called prides! The male lion's fluffy mane helps him look strong and protects his neck in fights." },
  { q: "Which African animal is the tallest in the world?", choices: ["Elephant", "Giraffe", "Ostrich", "Hippo"], answer: "Giraffe", emoji: "\u{1F992}", fact: "Giraffes can grow up to 6 metres tall \u2014 taller than a double-decker bus! Their long necks help them reach leaves at the very top of trees." },
  { q: "Which is the LARGEST desert in the whole world?", choices: ["Gobi Desert", "Sahara Desert", "Kalahari Desert", "Arabian Desert"], answer: "Sahara Desert", emoji: "\u{1F335}", fact: "The Sahara Desert is almost as big as the entire USA! Despite being so hot and dry, some people called the Tuareg have lived there for thousands of years." },
  { q: "Which African bird is famous for its beautiful pink colour?", choices: ["Penguin", "Flamingo", "Eagle", "Parrot"], answer: "Flamingo", emoji: "\u{1F9A9}", fact: "Flamingos are actually born white! They turn pink from eating tiny pink shrimp and algae. If they stop eating pink food, they slowly turn white again!" },
  { q: "What do we call the huge yearly journey African animals make to find food and water?", choices: ["Migration", "Vacation", "Exploration", "Adventure"], answer: "Migration", emoji: "\u{1F30D}", fact: "Over 2 million wildebeest, zebras, and gazelles travel 3,000 km every year in the Great Migration \u2014 it's the biggest animal journey on Earth!" }
];
function AfricaGame() {
