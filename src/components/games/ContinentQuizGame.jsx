...
const BG = "#E8FBF5";
const QUESTIONS = [
  { q: "Which is the LARGEST continent in the world?", choices: ["Africa", "Asia", "Europe", "South America"], answer: "Asia", emoji: "\u{1F30F}", fact: "Asia is enormous \u2014 it covers about 30% of Earth's land area and is home to over 4.5 billion people! That's more than half the people on the whole planet." },
  { q: "Which continent is completely covered in ice and snow, and has NO permanent human residents?", choices: ["Arctic", "Antarctica", "Greenland", "North America"], answer: "Antarctica", emoji: "\u{1F9CA}", fact: "Antarctica is the coldest, driest, and windiest continent on Earth. Scientists visit to study it, but no one actually lives there permanently!" },
  { q: "Which continent is shaped like a triangle and has the Amazon rainforest \u2014 the world's largest jungle?", choices: ["Africa", "Asia", "South America", "Australia"], answer: "South America", emoji: "\u{1F33F}", fact: "The Amazon Rainforest covers most of northern South America and produces about 20% of the world's oxygen. That's why it's called 'the lungs of the Earth'!" },
  { q: "Which is the SMALLEST continent \u2014 also a country all by itself?", choices: ["Europe", "Australia", "Antarctica", "South America"], answer: "Australia", emoji: "\u{1F998}", fact: "Australia is both a continent and a country! It's home to unique animals found nowhere else on Earth \u2014 like kangaroos, koalas, and the platypus." },
  { q: "Which continent has the most countries \u2014 54 in total?", choices: ["Asia", "Europe", "Africa", "South America"], answer: "Africa", emoji: "\u{1F30D}", fact: "Africa has 54 countries and over 2,000 different languages! It is the second-largest continent, and is incredibly diverse in its people, landscapes, and wildlife." },
  { q: "How many continents are there in total on planet Earth?", choices: ["5", "6", "7", "8"], answer: "7", emoji: "\u{1F30E}", fact: "The 7 continents are: Africa, Antarctica, Asia, Australia, Europe, North America, and South America. Remember them by the song: 'Seven Continents of the world!'" }
];
function ContinentQuizGame() {
