...
const BG = "#FFF0F5";
const QUESTIONS = [
  { q: "What does 'UN' stand for?", choices: ["Universal Network", "United Nations", "Union of Neighbours", "United Nomads"], answer: "United Nations", emoji: "\u{1F310}", fact: "The United Nations was founded in 1945 after World War II, to help countries talk instead of fight. Today 193 countries are members \u2014 almost every country on Earth!" },
  ...
  { q: "Which UN organisation works to give all children around the world the right to education, health, and safety?", choices: ["UNESCO", "WHO", "UNICEF", "IMF"], answer: "UNICEF", emoji: "\u{1F9D2}", fact: "UNICEF stands for 'United Nations Children's Fund'. It helps over 190 million children with clean water, vaccines, schools, and protection from danger every year." },
  { q: "Where is the United Nations headquarters located?", choices: ["London, UK", "Geneva, Switzerland", "New York, USA", "Paris, France"], answer: "New York, USA", emoji: "\u{1F5FD}", fact: "The UN headquarters sits on the east side of Manhattan in New York City. World leaders travel there to meet, debate, and work together on global problems." },
  { q: "How many official languages does the United Nations use for its meetings and documents?", choices: ["2", "4", "6", "10"], answer: "6", emoji: "\u{1F5E3}\uFE0F", fact: "The 6 official UN languages are: Arabic, Chinese, English, French, Russian, and Spanish. These languages are spoken by the majority of the world's population." }
];
function UNGame() {
  ...
  if (done) return <div className="text-center space-y-5 py-4 font-display">
      <div className="text-7xl animate-bounce">{score === QUESTIONS.length ? "\u{1F3C6}" : score >= 4 ? "\u2B50" : "\u{1F310}"}</div>
