...
const QUESTIONS = [
  { q: "Which type of climate has heavy rain and hot temperatures ALL YEAR — like in Indonesia?", choices: ["Polar", "Desert", "Tropical", "Temperate"], answer: "Tropical", emoji: "🌴", fact: "Tropical climates stay warm all year with lots of rain! Indonesia, Brazil, and parts of Africa are tropical. Most of the world's rainforests are found here." },
  { q: "Which climate type gets FOUR seasons — spring, summer, autumn, and winter?", choices: ["Tropical", "Desert", "Polar", "Temperate"], answer: "Temperate", emoji: "🍂", fact: "Temperate climates have four distinct seasons. Countries like the UK, France, and Japan have temperate climates — warm summers and cold (but not extreme) winters." },
  { q: "In which climate is it SNOWY and extremely cold almost all year round?", choices: ["Desert", "Tropical", "Temperate", "Polar"], answer: "Polar", emoji: "🧊", fact: "Polar climates near the North and South Poles are the coldest on Earth. Very few plants or animals can survive there — but polar bears and penguins have adapted!" },
  { q: "Which climate gets VERY LITTLE rain and is extremely hot and dry during the day?", choices: ["Polar", "Tropical", "Temperate", "Desert"], answer: "Desert", emoji: "🏜️", fact: "Deserts get less than 25cm of rain per year! The Sahara Desert in Africa is the world's biggest hot desert. The Arabian Desert is also a vast, dry desert." },
  { q: "What do we call the regular pattern of temperature and rainfall a region gets over many years?", choices: ["Weather", "Climate", "A storm", "A season"], answer: "Climate", emoji: "🌍", fact: "Climate is the long-term average weather of a place. Weather changes day to day ('it's raining today'), but climate is the overall pattern ('this city is usually dry')." },
  { q: "What causes the seasons — why is it hot in summer and cold in winter?", choices: ["The moon moves closer", "Earth tilts as it orbits the sun", "The sun gets bigger", "Clouds block the sun"], answer: "Earth tilts as it orbits the sun", emoji: "🌞", fact: "Earth is tilted at 23.5°. When your part of Earth is tilted TOWARD the sun, it's summer. When tilted AWAY, it's winter. This is why seasons are opposite in the north and south hemispheres!" },
];

export default function WeatherSortGame() {
    ...
    <div className="space-y-4 font-display">
      ...
      <div className="space-y-2.5">
        {q.choices.map((choice, idx) => {
          ...
          else if (choice === selected) { bg = "#E8FBF5"; border = `3px solid ${COLOR}`; textColor = DARK; }
          return (
